document.querySelector('#submit').addEventListener('click', function(event) {
    ...
    let url = "https://api.whatsapp.com/send?phone=+50258434148&text=*_Reserva%20de%20Cita*%0A%0A*Nombre*%0A" + cliente + 
    "%0A*Fecha de Cita*%0A" + fecha + 
    "%0A*Horario de Cita*%0A" + hora + 
